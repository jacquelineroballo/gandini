        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-construction-gray-600 max-w-3xl mx-auto">
              Ofrecemos una amplia gama de servicios de construcción y albañilería para satisfacer las necesidades específicas de cada proyecto.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="relative">
              <div className="bg-white p-8 rounded-lg shadow-lg text-center h-full hover-scale">
                <div className="w-12 h-12 bg-construction-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">1</div>
            ...
            <div className="relative">
              <div className="bg-white p-8 rounded-lg shadow-lg text-center h-full hover-scale">
                <div className="w-12 h-12 bg-construction-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">2</div>
            ...
            <div className="relative">
              <div className="bg-white p-8 rounded-lg shadow-lg text-center h-full hover-scale">
                <div className="w-12 h-12 bg-construction-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">3</div>
            ...
            <div>
              <div className="bg-white p-8 rounded-lg shadow-lg text-center h-full hover-scale">
                <div className="w-12 h-12 bg-construction-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">4</div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-8">
              Nuestro equipo está listo para ayudarte a hacerlo realidad. Contáctanos para una consulta personalizada.
            </p>
            <Link to="/contacto">
