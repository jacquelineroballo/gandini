...
import {
  Briefcase, Phone, ChevronDown, MenuIcon, X, Home, 
  Settings, FileText, Activity, CheckCircle, HelpCircle,
  Clock, Award
} from "lucide-react";
        ...
        >
          <Link to="/" className="flex items-center">
            ...
            >
              ...
              >
                <motion.span 
                  className="text-teal-500 relative inline-block"
                  whileHover={{ 
                    scale: 1.1,
              ...
              <NavigationMenuList>
                    ...
                    <Link to={link.href}>
                      <NavigationMenuLink
                        className={cn(
                          ...
                          isActive(link.href) ? "bg-teal-500/10 text-teal-500 font-semibold" : "text-gray-700 dark:text-gray-200"
                        )}
                      >
                        <motion.div 
                ...
                <NavigationMenuItem>
                  <NavigationMenuTrigger className={cn(
                    "group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-teal-500/10 hover:text-teal-500 focus:bg-teal-500/10 focus:text-teal-500 focus:outline-none disabled:pointer-events-none disabled:opacity-50",
                    isActive("/servicios-detalle") ? "bg-teal-500/10 text-teal-500" : "text-gray-700 dark:text-gray-200"
                  )}>
                      ...
                      {[
                        {
                          ...
                          description: "Casas y edificios residenciales con los más altos estándares",
                          icon: Home
                        },
                        {
          ...
          <div className="lg:hidden">
            <Drawer>
              <DrawerTrigger asChild>
                <Button variant="outline" size="icon" className="h-9 w-9 border-teal-500/20 hover:bg-teal-500/10 hover:text-teal-500">
              ...
              <DrawerContent className="bg-white dark:bg-gray-900 max-h-[85vh]">
                <DrawerHeader>
                  <DrawerTitle className="flex items-center justify-center">
                    ...
                    <span className="text-blue-600">tora</span>
                  </DrawerTitle>
                ...
                <div className="px-4 py-2 space-y-2">
                  ...
                  <div className="py-2">
                    <p className="text-sm font-medium text-muted-foreground mb-2 pl-2">Especialidades</p>
                    {[
