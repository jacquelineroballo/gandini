...
const Hero = ({ title, subtitle, backgroundImage, buttonText, buttonLink }: HeroProps) => {
	...
	return (
		...
		>
			...
			<div className='container mx-auto px-4 z-10 text-center'>
				...
				>
					<Link to={buttonLink}>
						<Button className='bg-teal-500 hover:bg-teal-600 text-white px-8 py-6 text-lg rounded-md flex items-center gap-2 group shadow-[0_0_15px_rgba(20,184,166,0.5)] btn-glow mx-auto'>
							{buttonText}
							<motion.div
								animate={{ x: [0, 5, 0] }}
								transition={{
